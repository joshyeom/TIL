...
작성일시: 2022년 9월 26일 오전 10:01
최종 편집일시: 2022년 9월 28일 오전 9:24
...
# [Symbol.iterator](https://ko.javascript.info/iterable#ref-1686)
...
# [문자열은 이터러블입니다](https://ko.javascript.info/iterable#ref-1687)
...
# [이터레이터를 명시적으로 호출하기](https://ko.javascript.info/iterable#ref-1688)
...
# [Array.from](https://ko.javascript.info/iterable#ref-1689)
...
*let arr = Array.from(arrayLike); // (*)*alert(arr.pop()); // World (메서드가 제대로 동작합니다.)
```

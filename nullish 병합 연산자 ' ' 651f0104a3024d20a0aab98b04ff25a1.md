...
작성일시: 2022년 9월 4일 오후 3:43
최종 편집일시: 2022년 9월 4일 오후 3:54
...
# ['??'와 '||'의 차이](https://ko.javascript.info/nullish-coalescing-operator#ref-1948)
...
# [연산자 우선순위](https://ko.javascript.info/nullish-coalescing-operator#ref-1949)
...
```jsx
*let x = (1 && 2) ?? 3; // 제대로 동작합니다.*alert(x); // 2
```

...
작성일시: 2022년 9월 5일 오후 5:30
최종 편집일시: 2022년 9월 6일 오후 2:31
...
- 인수가 하나도 없을 땐 괄호를 비워놓으면 됩니다. 다만, 이 때 괄호는 생략할 수 없습니다.
    ...
    # [본문이 여러 줄인 화살표 함수](https://ko.javascript.info/arrow-functions-basics#ref-1760)
    ...
    ****[화살표 함수로 변경하기](https://ko.javascript.info/arrow-functions-basics#ref-2235)****
